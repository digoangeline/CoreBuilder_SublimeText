...
class WinINetDownloader(DecodingDownloader, LimitingDownloader, CachingDownloader):
    ...
    def download(self, url, error_message, timeout, tries, request_type, request_post_body, prefer_cached=False):
        """
        ...
        while tries > 0:
            ...
            try:
                ...
                http_connection = wininet.HttpOpenRequestW(self.tcp_connection, request_type, path, u'HTTP/1.1', None, None, http_flags, 0)
                ...
                request_post_body_len = 0
                if request_post_body:
                ...
                if self.debug:
                    ...
                    console_write(u"  %s %s HTTP/1.1" % (request_type, path))
                    for header, value in request_headers.items():
                    ...
                    if request_post_body:
                        console_write("  {0}".format(request_post_body))
