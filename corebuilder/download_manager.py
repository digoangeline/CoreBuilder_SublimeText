...
class DownloadManager(object):
    ...
    def fetch(self, url, error_message, request_type=u'GET', request_post_body=None, prefer_cached=False):
        """
        ...
        try:
            return self.downloader.download(url, error_message, timeout, 3, request_type, request_post_body, prefer_cached)
